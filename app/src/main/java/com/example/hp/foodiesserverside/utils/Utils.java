package com.example.hp.foodiesserverside.utils;
...
//        }
    ...
    public Date getDateFromString(int year, int month, int dayOfMonth) {
        try {
            return new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).parse(year + "-" + (month + 1) + "-" + +dayOfMonth);
